  ...
  return (
    <div className="min-h-screen bg-background overflow-x-hidden">
      ...
      <section className="relative min-h-[50vh] sm:min-h-[70vh] flex items-center justify-center px-4 sm:px-6 lg:px-8 overflow-hidden">
        ...
        <div className="hidden sm:block absolute top-1/4 left-1/4 w-96 h-96 bg-primary/20 rounded-full blur-[128px] animate-pulse" />
        <div className="hidden sm:block absolute bottom-1/4 right-1/4 w-80 h-80 bg-accent/15 rounded-full blur-[100px] animate-pulse" style={{ animationDelay: '1s' }} />
        <div className="hidden sm:block absolute top-1/2 right-1/3 w-64 h-64 bg-primary/10 rounded-full blur-[80px] animate-pulse" style={{ animationDelay: '2s' }} />
        ...
        <div className="relative z-10 mx-auto max-w-5xl text-center px-2">
          <Reveal>
            {/* Floating Badge */}
            <div className="inline-flex items-center gap-2 px-4 sm:px-5 py-2 sm:py-2.5 rounded-full bg-primary/10 border border-primary/20 backdrop-blur-sm mb-6 sm:mb-8 hover:bg-primary/15 hover:border-primary/30 transition-all duration-300 cursor-default">
              <div className="relative">
                <Sparkles className="h-3.5 w-3.5 sm:h-4 sm:w-4 text-primary" />
                <div className="absolute inset-0 animate-ping">
                  <Sparkles className="h-3.5 w-3.5 sm:h-4 sm:w-4 text-primary opacity-50" />
                </div>
              </div>
          ...
          <Reveal delay={100}>
            ...
            <div className="mb-6 sm:mb-10 flex justify-center">
              <div className="relative group">
                {/* Glow layers */}
                <div className="absolute inset-0 blur-[40px] sm:blur-[60px] bg-primary/50 rounded-full scale-125 sm:scale-150 group-hover:scale-[1.75] transition-transform duration-700" />
                <div className="absolute inset-0 blur-2xl sm:blur-3xl bg-gradient-to-br from-primary to-accent opacity-40 rounded-full scale-110 sm:scale-125 group-hover:opacity-60 transition-all duration-500" />

                {/* Main Icon Container */}
                <div className="relative bg-gradient-to-br from-primary to-primary/80 rounded-2xl sm:rounded-3xl p-5 sm:p-8 shadow-2xl shadow-primary/30 group-hover:shadow-primary/50 transition-all duration-500 group-hover:scale-105">
                  <MessageSquare className="h-10 w-10 sm:h-16 sm:w-16 text-primary-foreground drop-shadow-lg" />
                </div>
              </div>
            </div>
          </Reveal>
      ...
      <section className="relative py-8 sm:py-12 px-3 sm:px-6 lg:px-8">
        ...
        <div className="hidden sm:block absolute left-0 top-1/2 -translate-y-1/2 w-96 h-96 bg-primary/10 rounded-full blur-[128px]" />
        <div className="hidden sm:block absolute right-0 top-1/3 w-80 h-80 bg-accent/10 rounded-full blur-[100px]" />
          ...
          <Reveal>
            <div className="text-center mb-6 sm:mb-8">
              <div className="inline-flex items-center gap-2 px-3 sm:px-4 py-1.5 sm:py-2 rounded-full bg-primary/10 border border-primary/20 mb-4 sm:mb-6">
                ...
                <span className="text-xs sm:text-sm font-medium text-primary">Latest Threads</span>
              </div>
            </div>
          </Reveal>
