...
const productTypes = [
  ...
  { value: "art", label: "Art" },
  { value: "3d_asset", label: "3D Assets" },
  { value: "illustration", label: "Illustrations" },
  { value: "icon_pack", label: "Icon Packs" },
  ...
  { value: "notion_template", label: "Notion Templates" },
  { value: "figma_file", label: "Figma Files" },
  { value: "lightroom_preset", label: "Lightroom Presets" },
  { value: "video_lut", label: "Video LUTs" },
