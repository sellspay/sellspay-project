  ...
  return (
    <div className="min-h-screen bg-background overflow-hidden">
      ...
      <section className="relative min-h-[90vh] flex items-center justify-center px-4 sm:px-6 lg:px-8 overflow-hidden">
        ...
        {/* Floating Orbs */}
        <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-[#5865F2]/20 rounded-full blur-[128px] animate-pulse" />
        ...
        <div className="absolute top-1/2 right-1/3 w-64 h-64 bg-indigo-500/10 rounded-full blur-[80px] animate-pulse" style={{ animationDelay: '2s' }} />
        ...
        <div className="relative z-10 mx-auto max-w-5xl text-center">
          <Reveal>
            {/* Floating Badge */}
            <div className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-[#5865F2]/10 border border-[#5865F2]/20 backdrop-blur-sm mb-8 hover:bg-[#5865F2]/15 hover:border-[#5865F2]/30 transition-all duration-300 cursor-default">
              <div className="relative">
                <Sparkles className="h-4 w-4 text-[#5865F2]" />
                <div className="absolute inset-0 animate-ping">
                  <Sparkles className="h-4 w-4 text-[#5865F2] opacity-50" />
                </div>
              </div>
              <span className="text-sm font-medium bg-gradient-to-r from-[#5865F2] to-violet-400 bg-clip-text text-transparent">
          ...
          <Reveal delay={100}>
            ...
            <div className="mb-10 flex justify-center">
              <div className="relative group">
                {/* Glow layers */}
                <div className="absolute inset-0 blur-[60px] bg-[#5865F2]/50 rounded-full scale-150 group-hover:scale-175 transition-transform duration-700" />
                <div className="absolute inset-0 blur-3xl bg-gradient-to-br from-[#5865F2] to-violet-600 opacity-40 rounded-full scale-125 group-hover:opacity-60 transition-all duration-500" />
                
                {/* Main Logo Container */}
                <div className="relative bg-gradient-to-br from-[#5865F2] to-[#4752C4] rounded-3xl p-8 shadow-2xl shadow-[#5865F2]/30 group-hover:shadow-[#5865F2]/50 transition-all duration-500 group-hover:scale-105">
                  <svg width="72" height="55" viewBox="0 0 71 55" fill="none" xmlns="http://www.w3.org/2000/svg" className="drop-shadow-lg">
      ...
      <section className="relative py-24 px-4 sm:px-6 lg:px-8">
        {/* Background Effects */}
        <div className="absolute inset-0 bg-gradient-to-b from-background via-[#5865F2]/5 to-background" />
        <div className="absolute left-0 top-1/2 -translate-y-1/2 w-96 h-96 bg-[#5865F2]/10 rounded-full blur-[128px]" />
        <div className="absolute right-0 top-1/3 w-80 h-80 bg-violet-500/10 rounded-full blur-[100px]" />
          ...
          <Reveal>
            <div className="text-center mb-16">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#5865F2]/10 border border-[#5865F2]/20 mb-6">
                <Crown className="h-4 w-4 text-[#5865F2]" />
                <span className="text-sm font-medium text-[#5865F2]">Exclusive Benefits</span>
              </div>
            ...
            {benefits.map((benefit, index) => (
              <Reveal key={benefit.title} delay={index * 80}>
                <div className="group relative h-full">
                  {/* Card Glow */}
                  <div className={`absolute inset-0 bg-gradient-to-br ${benefit.gradient} rounded-3xl blur-xl opacity-0 group-hover:opacity-20 transition-all duration-500`} />
                  
                  <div className="relative h-full bg-gradient-to-br from-card/90 to-card/50 backdrop-blur-xl border border-border/50 rounded-3xl p-8 hover:border-[#5865F2]/30 transition-all duration-500 group-hover:-translate-y-2 overflow-hidden">
                    {/* Subtle Gradient Overlay */}
                    <div className={`absolute inset-0 bg-gradient-to-br ${benefit.gradient} opacity-0 group-hover:opacity-[0.03] transition-opacity duration-500`} />
                    
                    {/* Icon */}
                    <div className={`relative inline-flex p-4 rounded-2xl bg-gradient-to-br ${benefit.gradient} mb-6 shadow-lg`}>
