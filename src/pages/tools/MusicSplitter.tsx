...
import { Upload, Music2, Loader2, X, Volume2 } from "lucide-react";
...
export default function MusicSplitter() {
  ...
  const getTracks = () => {
    ...
    for (const stemKey of stemOrder) {
      const stem = result[stemKey as keyof ProcessingResult];
      if (stem) {
        tracks.push({
          id: stemKey,
          name: stemNames[stemKey] || stemKey,
          url: stem.url,
          color: stemColors[stemKey] || "#888888",
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Split into {getTracks().length} stems
                </p>
              </div>
            </div>
