              ...
              <>
                ...
                <div className="space-y-4">
                  <form onSubmit={handleResetPassword} className="space-y-4">
                    ...
                    {error && <p className="text-destructive text-sm text-center">{error}</p>}
                    <button type="submit" disabled={loading} className="w-full h-11 rounded-lg bg-primary text-primary-foreground font-semibold text-sm transition-all hover:bg-primary/90 disabled:opacity-50">
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-2.5">
                    ...
                    >
                      ...
                      <span>{discordLoading ? 'Connecting...' : 'Continue with Discord'}</span>
                    </button>
                  </div>
                  ...
                  <form onSubmit={handleLogin} className="space-y-3">
                    ...
                    <div className="flex items-center gap-2">
                      <input
                        ...
                        className="w-3.5 h-3.5 rounded border-border text-primary focus:ring-primary/20 focus:ring-1 cursor-pointer"
                      />
