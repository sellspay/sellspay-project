...
export default function Login() {
  ...
  const handleDiscordSignIn = async () => {
    ...
    try {
      ...
      else throw new Error('Failed to initiate Discord login');
    } catch (err: any) {
          ...
          <div className="w-full max-w-[420px]">
            ...
            {!showForgotPassword && !showMfaVerification && (
              <p className="text-muted-foreground mb-6 text-sm">
                ...
                <Link to={`/signup${location.search}`} className="text-primary font-medium hover:underline">
                  Sign up
                </Link>
              </p>
            )}
            ...
            {showMfaVerification ? (
              <div className="space-y-6">
                ...
                <button
                  ...
                  className="w-full h-12 rounded-lg bg-primary text-primary-foreground font-medium transition-all duration-300 hover:bg-primary/90 disabled:opacity-50 flex items-center justify-center gap-2"
                >
              ...
              <div className="space-y-6">
                ...
                <form onSubmit={handleResetPassword} className="space-y-4">
                  ...
                  {resetMessage && <p className="text-sm text-center" style={{ color: 'hsl(142 76% 56%)' }}>{resetMessage}</p>}
                  {error && <p className="text-destructive text-sm text-center">{error}</p>}
                  <button type="submit" disabled={loading} className="w-full h-12 rounded-lg bg-primary text-primary-foreground font-medium transition-all hover:bg-primary/90 disabled:opacity-50">
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-3">
                  ...
                  <button
                    ...
                    className="w-full h-12 flex items-center justify-center gap-3 rounded-lg bg-card/60 border border-border text-foreground font-medium transition-all duration-300 hover:bg-[#5865F2] hover:text-white hover:border-[#5865F2]/60 disabled:opacity-50"
                  >
                    {discordLoading ? (
                      <Loader2 className="w-5 h-5 animate-spin" />
                    ) : (
                ...
                <form onSubmit={handleLogin} className="space-y-4">
                  ...
                  <div className="flex items-center gap-2">
                    <input
                      ...
                      className="w-4 h-4 rounded border-border bg-card/60 text-primary focus:ring-primary/20 focus:ring-2 cursor-pointer"
                    />
