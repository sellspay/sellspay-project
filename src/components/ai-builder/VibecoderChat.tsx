...
export function VibecoderChat({ 
  ...
  return (
    <div className="flex flex-col h-full overflow-hidden bg-[#1a1a1a] vibe-chat-container">
      ...
      {/* Chat area */}
      <div className="flex-1 overflow-y-auto overflow-x-hidden min-h-0 px-6 py-4 chat-scroll-area" ref={scrollRef}>
        {isEmpty ? (
