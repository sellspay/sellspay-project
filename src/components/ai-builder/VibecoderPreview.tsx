...
`;
// REMOVED: Loading overlay component - was causing mutation observer crashes
...
export function VibecoderPreview({
  ...
  // REMOVED: Loading overlay logic - causes mutation observer crash
  ...
  return (
    <div className="h-full w-full relative bg-zinc-950 flex flex-col">
      ...
      {/* REMOVED: Loading overlay - causes mutation observer crash when DOM churn is heavy */}

      {/* Sandpack preview/code - always visible */}
