  ...
  return (
    <section ref={sectionRef} className="relative min-h-[50vh] sm:min-h-[55vh] md:min-h-[60vh] lg:min-h-[88vh] flex items-center justify-center overflow-hidden px-4 sm:px-6 md:px-8 lg:px-0 py-6 sm:py-8 md:py-10 lg:py-0">
      ...
      >
        ...
        <span 
          className="text-xs sm:text-sm font-light tracking-[0.3em] uppercase text-foreground/60 whitespace-nowrap"
          style={{ 
        ...
        <span 
          className="text-xs font-medium tracking-wider text-foreground/40"
          style={{ 
            writingMode: 'vertical-rl',
            textOrientation: 'mixed',
            transform: 'rotate(180deg)'
      ...
      >
        <div className="border border-foreground/30 px-3 py-6">
          <span 
            className="text-xs font-bold tracking-[0.2em] uppercase text-foreground/80"
            style={{ 
              writingMode: 'vertical-rl',
              textOrientation: 'mixed'
            }}
        ...
        <div className="flex flex-col items-center text-center max-w-7xl mx-auto">
          ...
          >
            <Button 
              asChild 
              variant="outline"
              className="h-10 sm:h-12 lg:h-16 px-6 sm:px-10 lg:px-14 text-sm sm:text-base lg:text-lg font-medium tracking-wider rounded-full bg-transparent border-2 border-foreground/50 text-foreground hover:bg-foreground hover:text-background transition-all duration-300"
            >
              <Link to="/products">
                discover
              </Link>
      ...
      >
        <span className="text-foreground/40 text-xs sm:text-sm font-bold tracking-widest">★★★★★★★</span>
        <span className="text-foreground/30 text-[10px] sm:text-xs font-light">sellspay.com</span>
      </div>
      ...
      >
        <div className="text-foreground/70 text-sm sm:text-base font-medium leading-relaxed">
          <span className="block">{content.hero_stats.assets}</span>
          <span className="block">Assets</span>
          <span className="block mt-2 text-foreground/40 text-xs tracking-wider">#endless creativity</span>
        </div>
      </div>
      ...
      >
        <div className="w-px h-8 sm:h-12 bg-foreground/30 animate-pulse" />
      </div>
    </section>
  );
}
