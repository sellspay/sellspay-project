...
export function MangaView({ config }: MangaViewProps) {
  return (
    ...
    >
      ...
      <div className="p-4 sm:p-6 bg-gradient-to-br from-pink-900/20 via-slate-900/60 to-black">
        <div className="grid grid-cols-4 grid-rows-2 gap-2 sm:gap-3" style={{ minHeight: '500px' }}>
          {/* Left tall image 1 */}
          <div className={`row-span-2 bg-gradient-to-br ${gridGradients[0]} relative overflow-hidden border border-pink-500/10 min-h-[200px]`}>
          ...
          {/* Center tall image 2 */}
          <div className={`row-span-2 bg-gradient-to-br ${gridGradients[1]} relative overflow-hidden border border-rose-500/20 min-h-[200px]`}>
          ...
          {/* Top right images */}
          <div className={`bg-gradient-to-br ${gridGradients[2]} relative overflow-hidden border border-pink-500/10 min-h-[100px]`}>
            <div className="absolute inset-0 bg-gradient-to-t from-black/30 to-transparent" />
            <span className="absolute top-2 left-2 text-[10px] text-pink-300/40 uppercase">Before</span>
          </div>
          <div className={`bg-gradient-to-br ${gridGradients[3]} relative overflow-hidden border border-pink-500/10 min-h-[100px]`}>
            <div className="absolute inset-0 bg-gradient-to-t from-black/30 to-transparent" />
          ...
          {/* Bottom right images */}
          <div className={`bg-gradient-to-br ${gridGradients[4]} relative overflow-hidden border border-pink-500/10 min-h-[100px]`}>
            <div className="absolute inset-0 bg-gradient-to-t from-black/30 to-transparent" />
            <span className="absolute top-2 left-2 text-[10px] text-pink-300/40 uppercase">Before</span>
          </div>
          <div className={`bg-gradient-to-br ${gridGradients[5]} relative overflow-hidden border border-pink-500/10 min-h-[100px]`}>
