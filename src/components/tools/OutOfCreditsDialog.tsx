...
export function OutOfCreditsDialog({ open, onOpenChange }: OutOfCreditsDialogProps) {
  ...
  const { creditBalance, subscription } = useCredits();
  ...
  return (
    <>
        ...
        <DialogContent className="sm:max-w-md">
          ...
          <div className="space-y-3 py-4">
            <button
              ...
              className="w-full flex items-center gap-3 p-3 rounded-lg bg-gradient-to-r from-amber-500/10 to-orange-500/5 border border-amber-500/20 hover:from-amber-500/20 hover:to-orange-500/10 hover:border-amber-500/30 transition-all cursor-pointer text-left"
            >
            ...
            <button
              ...
              className="w-full flex items-center gap-3 p-3 rounded-lg bg-secondary/50 border border-border hover:bg-secondary/70 hover:border-border/80 transition-all cursor-pointer text-left"
            >
      ...
      <TopUpDialog
        ...
        subscriptionTier={subscription?.status === 'active' ? 'pro' : undefined}
      />
    </>
  );
}