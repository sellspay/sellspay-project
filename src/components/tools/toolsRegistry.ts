...
export const toolsRegistry: ToolRegistryEntry[] = [
  ...
  { id: "video-generator", name: "Image Animator", category: "quick_tool", subcategory: "media_creation", icon: Clapperboard, description: "Animate any image into a video with AI", creditCost: 50, isPro: true, isActive: true, sortOrder: 96 },
  { id: "motion-transfer", name: "Motion Transfer", category: "quick_tool", subcategory: "media_creation", icon: RefreshCw, description: "Transfer motion from one video onto another", creditCost: 50, isPro: true, isActive: true, sortOrder: 97 },
  { id: "image-editor", name: "Edit Image", category: "quick_tool", subcategory: "media_creation", icon: PenLine, description: "Edit and enhance images with AI-powered tools", creditCost: 1, isPro: false, isActive: true, sortOrder: 97, comingSoon: true, supportsModes: "image" },
  { id: "text-to-video", name: "Text to Video", category: "quick_tool", subcategory: "media_creation", icon: Clapperboard, description: "Transform text prompts into cinematic video clips", creditCost: 3, isPro: true, isActive: true, sortOrder: 98, comingSoon: true },
