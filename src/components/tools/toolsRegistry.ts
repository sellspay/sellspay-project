...
export const toolsRegistry: ToolRegistryEntry[] = [
  ...
  { id: "thumbnail-generator", name: "Thumbnail Generator", category: "quick_tool", subcategory: "store_growth", icon: Image, description: "Create eye-catching product thumbnails with AI", creditCost: 2, isPro: false, isActive: true, sortOrder: 20, comingSoon: true },
  ...
  { id: "upsell-suggestions", name: "Upsell & Bundle Ideas", category: "quick_tool", subcategory: "store_growth", icon: PackagePlus, description: "AI-powered bundle and upsell recommendations", creditCost: 1, isPro: true, isActive: true, sortOrder: 40, comingSoon: true },
  ...
  { id: "short-form-script", name: "Short-Form Script", category: "quick_tool", subcategory: "social_content", icon: Clapperboard, description: "Generate scripts for TikTok, Reels, and Shorts", creditCost: 1, isPro: false, isActive: true, sortOrder: 60, comingSoon: true },
  ...
  // ── Creator Utility ──
  { id: "background-remover", name: "Background Remover", category: "quick_tool", subcategory: "utility", icon: Eraser, description: "Remove image backgrounds instantly", creditCost: 1, isPro: false, isActive: true, sortOrder: 140, comingSoon: true },
  { id: "image-upscaler", name: "Image Upscaler", category: "quick_tool", subcategory: "utility", icon: Maximize, description: "Upscale images to higher resolution", creditCost: 1, isPro: false, isActive: true, sortOrder: 150, comingSoon: true },
  ...
  { id: "generate-bundles", name: "Generate Bundles & Upsells", category: "store_assistant", icon: Package, description: "AI suggests product bundles and upsell combos", creditCost: 1, isPro: true, isActive: true, sortOrder: 340, comingSoon: true },
];
