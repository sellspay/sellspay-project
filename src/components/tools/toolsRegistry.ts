...
export const toolsRegistry: ToolRegistryEntry[] = [
  ...
  { id: "video-generator", name: "Video Generator", category: "quick_tool", subcategory: "media_creation", icon: Clapperboard, description: "Create stunning AI-generated videos from prompts", creditCost: 3, isPro: true, isActive: true, sortOrder: 96, comingSoon: true },
