...
import vid8 from "@/assets/inspirations/vid-8.jpg";
import vid9 from "@/assets/inspirations/vid-9.jpg";
import vid10 from "@/assets/inspirations/vid-10.jpg";
import vid11 from "@/assets/inspirations/vid-11.jpg";
import vid12 from "@/assets/inspirations/vid-12.jpg";
import vid13 from "@/assets/inspirations/vid-13.jpg";
import vid14 from "@/assets/inspirations/vid-14.jpg";
import vid15 from "@/assets/inspirations/vid-15.jpg";
import vid16 from "@/assets/inspirations/vid-16.jpg";
import vid17 from "@/assets/inspirations/vid-17.jpg";
...
const VIDEO_ITEMS: GalleryItem[] = [
  { src: vid1, label: "Space battle cockpit", prompt: "A cinematic scene of a futuristic spaceship cockpit with a pilot looking out at a nebula, sci-fi movie still, dramatic lighting, widescreen anamorphic look", toolId: "text-to-video" },
  { src: vid8, label: "Bioluminescent whale", prompt: "A massive bioluminescent whale breaching from dark ocean at night near an industrial shipyard, neon teal veins glowing, cinematic VFX shot, rain and lightning", toolId: "text-to-video" },
  { src: vid2, label: "Robot encounter", prompt: "Action movie scene, group of people standing in a futuristic white room with a small pink robot, cinematic wide shot, sci-fi thriller atmosphere", toolId: "text-to-video" },
  { src: vid9, label: "Night car chase", prompt: "Fast-paced car chase through narrow European streets at night, sparks flying, motion blur, adrenaline action movie still, widescreen cinematic", toolId: "text-to-video" },
  { src: vid3, label: "Arctic expedition", prompt: "Snowy mountain landscape with a lone figure running through deep snow, avalanche in background, cinematic action shot, dramatic scale, epic movie scene", toolId: "text-to-video" },
  { src: vid10, label: "Astronaut in space", prompt: "Astronaut floating in space with Earth reflected in helmet visor, stars and nebula behind, ultra realistic, IMAX movie still quality", toolId: "text-to-video" },
  { src: vid4, label: "Cyberpunk transit", prompt: "Neon-lit cyberpunk bus driving through a rainy night city, reflections on wet asphalt, dystopian atmosphere, cinematic color grading, movie still", toolId: "text-to-video" },
  { src: vid11, label: "Gladiator arena", prompt: "Ancient Roman gladiator arena with thousands of spectators, dramatic overhead view, dust and sand, epic historical movie scene, golden hour lighting", toolId: "text-to-video" },
  { src: vid5, label: "Retro phone booth", prompt: "Close up of a retro neon phone booth at night with people inside, 80s vibe, rain, colorful reflections, cinematic street photography", toolId: "text-to-video" },
  { src: vid12, label: "Haute couture runway", prompt: "Luxury fashion runway show with dramatic spotlights, model walking in avant-garde haute couture, smoke machine, dark elegant atmosphere, fashion week", toolId: "text-to-video" },
  { src: vid13, label: "Wolf under aurora", prompt: "A wolf howling on a cliff edge under northern lights aurora borealis, snow falling, dramatic wildlife cinematography, epic nature documentary", toolId: "text-to-video" },
  { src: vid14, label: "Medieval siege", prompt: "Massive medieval castle siege with catapults firing and fire arrows in the night sky, epic battle scene, Lord of the Rings style cinematography", toolId: "text-to-video" },
  { src: vid6, label: "Floating tech", prompt: "Sleek white laptop floating in a minimalist white void with dramatic shadow, product photography, ultra clean, futuristic tech shot", toolId: "text-to-video" },
  { src: vid15, label: "Underwater ruins", prompt: "Underwater city ruins with ancient Greek columns covered in coral and schools of colorful fish, volumetric light rays, cinematic deep sea exploration", toolId: "text-to-video" },
  { src: vid7, label: "Glamorous event", prompt: "Two elegant women at a glamorous event in pink tulle dresses, luxury hotel lobby, golden lighting, editorial fashion photography", toolId: "text-to-video" },
  { src: vid16, label: "Michelin star plating", prompt: "Professional chef plating an exquisite dish with tweezers, steam rising, close-up food photography, Michelin star kitchen, dramatic lighting", toolId: "text-to-video" },
  { src: vid17, label: "Shibuya crossing", prompt: "Time-lapse style photo of a bustling Tokyo Shibuya crossing at night, thousands of people with motion trails, long exposure, city energy, cinematic", toolId: "text-to-video" },
];
      ...
      >
        ...
        <div className="p-5 space-y-4 overflow-y-auto custom-scrollbar">
          ...
          <div className="relative rounded-xl bg-white/[0.04] border border-white/[0.06] p-4">
            <p className="text-[13px] text-white/70 leading-relaxed pr-8">
              {item.prompt}
            </p>
            <button
              onClick={handleCopy}
