  ...
  const content = (
    <div
      ...
      className={cn(
        ...
        isActive
          ? "bg-[#1e3a8a]/30 text-foreground font-medium shadow-[0_0_0_1px_#3b82f6,0_0_12px_rgba(59,130,246,0.2)] border border-[#3b82f6]"
  ...
  return (
    <>
      <TooltipProvider delayDuration={0}>
        <aside className="h-full w-full bg-background overflow-hidden flex flex-col border-r border-border">
              {/* All Tools button */}
                            ...
                            <div className="space-y-0.5">
                              {tools.map(tool => {
                                ...
                                return (
                                  <div
                                    key={tool.id}
                                    className="flex items-center gap-2 px-2 py-1.5 rounded-lg hover:bg-accent group"
                                  >
                                    <button
                                      type="button"
                                      onClick={() => {
